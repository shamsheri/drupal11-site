...
<p>";
        // line 13
        yield t("Export a single configuration item to a file. See @config_overview_topic for more information about configuration.", ["@config_overview_topic" => ($context["config_overview_topic"] ?? null), ]);
        yield "</p>
<h2>";
        // line 14
        yield t("Steps", []);
...
<ol>
  <li>";
        // line 16
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Development</em> &gt; <em>Configuration synchronization</em> &gt; <em>Export</em> &gt; <em>@single_export_link</em>.", ["@single_export_link" => ($context["single_export_link"] ?? null), ]);
        yield "</li>
  <li>";
        // line 17
