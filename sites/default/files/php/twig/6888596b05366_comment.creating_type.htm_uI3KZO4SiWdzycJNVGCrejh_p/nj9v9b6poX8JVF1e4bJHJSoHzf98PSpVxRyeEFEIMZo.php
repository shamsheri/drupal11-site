...
<p>";
        // line 21
        yield t("Create a new comment type. See @comment_overview_topic for information about comments and comment types.", ["@comment_overview_topic" => ($context["comment_overview_topic"] ?? null), ]);
        yield "</p>
<h2>";
        // line 22
...
<p>";
        // line 23
        yield t("Users with the <em>@comment_permissions_link</em> permission (typically administrators) can create comment types.", ["@comment_permissions_link" => ($context["comment_permissions_link"] ?? null), ]);
        yield "</p>
<h2>";
        // line 24
        yield t("Steps", []);
...
<ol>
  <li>";
        // line 26
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Structure</em> &gt; <em>@comment_types_link</em>.", ["@comment_types_link" => ($context["comment_types_link"] ?? null), ]);
        yield "</li>
  <li>";
        // line 27
  ...
  <li>";
        // line 29
        yield t("In the <em>Target entity type</em> field, select the entity type to be commented on. See @content_structure_topic for more about content entities and fields.", ["@content_structure_topic" => ($context["content_structure_topic"] ?? null), ]);
        yield "</li>
  <li>";
        // line 30
